...
class  nsm_l2_table_sync_master():
    def __init__(self):
        '''
        ...
        l2_table_array = []
        l2_table_array = nsm_def.convert_excel_to_array(l2_table_ws_name, l2_table_file, 3)
        ...
        for tmp_new_l2_table_array in new_l2_table_array:
            ...
            if_value = nsm_def.get_if_value(tmp_new_l2_table_array[1][3])
            tmp_new_l2_table_array[1].extend([if_value])
            tmp_new_l2_table_array[1].extend([str(nsm_def.split_portname(tmp_new_l2_table_array[1][3])[0])])

            # add logical port id for sort
            if tmp_new_l2_table_array[1][5] != '':
                if_value = nsm_def.get_if_value(tmp_new_l2_table_array[1][5])
                tmp_new_l2_table_array[1].extend([if_value])
                tmp_new_l2_table_array[1].extend([str(nsm_def.split_portname(tmp_new_l2_table_array[1][5])[0])])
        ...
        last_l2_table_tuple = {}
        last_l2_table_tuple = nsm_def.convert_array_to_tuple(last_l2_table_array)
