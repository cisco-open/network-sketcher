...
class  nsm_l1_table_from_master():
    def __init__(self):
        '''
        ...
        for tmp_device_table_array in device_table_array:
            ...
            if str(tmp_device_table_array[1][0]) == '':
                if str(tmp_device_table_array[1][2]) != '':
                    ...
                    if_value = nsm_def.get_if_value(tmp_device_table_array[1][3])
                    tmp_device_table_array[1].extend([if_value])
                    tmp_device_table_array[1].extend([str(nsm_def.split_portname(tmp_device_table_array[1][3])[0])])
        ...
        #print(overwrite_if_tuple)
        ### Convert to tuple
        master_device_table_tuple = nsm_def.convert_array_to_tuple(device_table_array)
        ...
        nsm_def.create_excel_sheet(ppt_meta_file, tmp_tmp_ws_name)
        input_tree_tuple = {}
        ...
        master_is_nsm = str(ppt_meta_file).lower().endswith('.nsm')
        if master_is_nsm:
            input_excel_name = nsm_def._get_staging_xlsx(ppt_meta_file)
        ...
        start_row = 1
        start_column = 0
        custom_table_name = input_excel_name
        ...
        nsm_def.remove_excel_sheet(ppt_meta_file, tmp_tmp_ws_name)
