...
class  nsm_l3_table_from_master():
    def __init__(self):
        '''
        ...
        # GET L2 TABLE
        self.l2_table_array = nsm_def.convert_master_to_array(ws_name_l2, excel_maseter_file, '<<L2_TABLE>>')
        self.l2_table_tuple = nsm_def.convert_array_to_tuple(self.l2_table_array)
        ...
        for tmp_l2_table_array in self.l2_table_array:
            if tmp_l2_table_array[0] != 1 and tmp_l2_table_array[0] != 2:
                ...
                if tmp_l2_table_array[1][3] != '' and tmp_l2_table_array[1][5] == '' and tmp_l2_table_array[1][6] == '' and tmp_l2_table_array[1][7] == '' and tmp_l2_table_array[1][3] not in used_l3_if_name:
                    if_name_array = nsm_def.split_portname(tmp_l2_table_array[1][3])
                    if_number = nsm_def.get_if_value(tmp_l2_table_array[1][3])
                    ...
                    if_name_array = nsm_def.split_portname(tmp_l2_table_array[1][5])
                    if_number = nsm_def.get_if_value(tmp_l2_table_array[1][5])
        ...
        L3_table_tuple = {}
        L3_table_tuple = nsm_def.convert_array_to_tuple(update_L3_table_array)
        ...
        L3_master_data_tuple = nsm_def.convert_array_to_tuple(excel_L3_table_array)
        #print('L3_master_data_tuple')
        #print(L3_master_data_tuple)
        if not master_is_nsm:
            nsm_def.create_excel_sheet(excel_maseter_file, ws_name_l3)

        # write L3_master_data_array tuple to Master data L3 sheet
        offset_row = 0
        offset_column = 0
        write_to_section = '_template_'
        nsm_def.write_excel_meta(L3_master_data_tuple, excel_maseter_file, ws_name_l3, write_to_section, offset_row, offset_column)

        ### TEST MODE ###
        #nsm_def.remove_excel_sheet(excel_maseter_file, 'Master_Data_L3')
...
class ns_l3_table_from_master_l3_sheet():
    def __init__(self):
        ...
        master_L3_array = []
        master_L3_array = nsm_def.convert_master_to_array('Master_Data_L3', excel_maseter_file, '<<L3_TABLE>>')
        ...
        L3_table_tuple = {}
        L3_table_tuple = nsm_def.convert_array_to_tuple(new_new_L3_table_array)
