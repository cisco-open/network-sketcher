...
class  nsm_l3_table_sync_master():
    def __init__(self):
        '''
        ...
        l3_table_array = []
        l3_table_array = nsm_def.convert_excel_to_array(l3_table_ws_name, l3_table_file, 3)
        ...
        for tmp_new_l3_table_array in new_l3_table_array:
            ...
            # add if id for sort
            if_value = nsm_def.get_if_value(tmp_new_l3_table_array[1][2])
            tmp_new_l3_table_array[1].extend([if_value])
            tmp_new_l3_table_array[1].extend([str(nsm_def.split_portname(tmp_new_l3_table_array[1][2])[0])])
            ...
            for tmp_tmp_new_l3_table_array in work_new_l3_table_array:
                ...
                if nsm_def.check_ip_format(tmp_tmp_new_l3_table_array) == 'IPv4':
                    tmp_ip_address_array.append([tmp_tmp_new_l3_table_array,nsm_def.get_ipv4_value(tmp_tmp_new_l3_table_array)])
        ...
        last_l3_table_tuple = {}
        last_l3_table_tuple = nsm_def.convert_array_to_tuple(last_l3_table_array)
